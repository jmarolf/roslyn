...
namespace Microsoft.VisualStudio.LanguageServices.EditorConfigSettings
{
    ...
    [Name(EditorConfigSettingsColumnDefinitions.DescriptionName)]
    internal class DescriptionNameColumnDefinition : TableColumnDefinitionBase
    {
        [ImportingConstructor]
        [Obsolete(MefConstruction.ImportingConstructorMessage, error: true)]
        public DescriptionNameColumnDefinition()
        {
        }
